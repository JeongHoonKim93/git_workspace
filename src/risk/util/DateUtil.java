...
public class DateUtil {
	...
	public static String addDay(String curDate, int day) throws ParseException{
	...
	/**
	  ...
	  public static void main(String[] args) {
		  new DateUtil().addWeek(-1);
		  new DateUtil().setDate("2009-07-23");
		  System.out.println(getWeekOfMonth());
		  System.out.println("Calendar.WEEK_OF_MONTH => "+Calendar.WEEK_OF_MONTH);
		  System.out.println(new DateUtil().getWeekDay(getWeekToDay("200908",1,"yyyy-MM-dd")));
	  }
