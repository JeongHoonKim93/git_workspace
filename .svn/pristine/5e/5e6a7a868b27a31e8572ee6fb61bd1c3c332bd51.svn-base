...
<script language="JavaScript" type="text/JavaScript">
	...
	function loadList(xp, yp, zp)
	{		
		frm = keyword_right.keygroup;
		var url = "behind_list.jsp?xp="+xp+"&yp="+yp+"&zp="+zp;
		ajax.post(url,'frm','behindList');
	}
	
	function boardData(obj) {
		var temp = obj.replace('imgID_','');
		temp = temp.split('_');
		loadList(temp[0], temp[1], temp[2]);
	}
	...
	function add_key()
	{
		...
		window.open(url, "pop_keyword", "width=400,height=300");
	}
	...
	function del_board(skr_seq,xp,yp,zp) {
		frm = keyword_right.keygroup;
		frm.tg.value = 'del_board';
		frm.skr_seq.value = skr_seq;
		frm.xp.value = xp;
		frm.yp.value = yp;
		frm.zp.value = zp;
		frm.submit();
...
<style>
	#board {width:770}
	#board th {height:30px;background:url('../../../images/common/board_top_bg.gif');}
	#board td {height:27px;border-bottom:1px #cfcfcf dotted;text-align:center; color:#707070;}
	#board .same {height:100%;border-bottom:1px #ffffff dotted;text-align:center; color:#707070;}
	#board dl {margin:0px; display: inline; list-style-type: none;}
	#board dd {width:7px; margin:0px; display: inline; list-style-type: none;}

	.board_category {color:#225bd1;font-size:11px;}
	.board_tit {width:100%; text-align:left; background:url('../images/common/icon_dot.gif') 5px 50% no-repeat; padding-left:10px; color:#000000;}
	.board_tit_01 {width:100%; text-align:left; background:url('../images/search/con_icon01.gif') 5px 50% no-repeat; padding-left:20px;}
	.board_tit_02 {width:100%; text-align:left; background:url('../images/search/con_icon02.gif') 5px 50% no-repeat; padding-left:20px;}
	.board_tit_03 {width:100%; text-align:left; background:url('../images/search/con_icon03.gif') 5px 50% no-repeat; padding-left:20px;}
</style>
</head>
...
<table style="width:100%;height:100%;" border="0" cellpadding="0" cellspacing="0">
	<tr>
			...
			<table width="820" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
						<tr>
							<td><img src="../../../images/admin/keyword/tit_icon.gif" /><img src="../../../images/admin/keyword/tit_0614.gif" /></td>
							<td align="right">
							<table border="0" cellpadding="0" cellspacing="0">
								<tr>
									<td class="navi_home">HOME</td>
									<td class="navi_arrow">관리자</td>
									<td class="navi_arrow2">영역지정키워드관리</td>
								</tr>
							</table>
							</td>
						</tr>
      ...
      <!-- 키워드그룹 선택시 해당 키워드리스트 출력 -->
      <table width="770" border="0" cellspacing="0" cellpadding="0" id="board" style="display:none;" >
		<tr>
			<td id="behindList"></td>
		</tr>
      </table>
