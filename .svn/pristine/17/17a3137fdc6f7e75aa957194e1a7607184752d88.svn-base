	...
	function del_sg()
	{
		if( tg_site.sg_seq.value ) {
			if( confirm('사이트그룹을 삭제하시겠습니까?') ) {
				location.href = "ifram_target_prc.jsp?mode=del&sgseq="+tg_site.sg_seq.value;
			}
		}
	}
      ...
      <tr>
		<td>
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td>
						<img src="../../../images/admin/site_type/admin_ico03.gif"  hspace="3">분류 그룹 선택
					</td>
				</tr>
				...
				<tr>
					...
					<%
						sglist = sitemng.getSiteGroupType();
...
<!--      <tr>-->
<!--        <td><img src="../../../images/admin/site_type/admin_ico03.gif" width="10" height="11" hspace="3">사이트 그룹 선택</td>-->
<!--      </tr>-->
<!--	  <form name="tg_site" action="ifram_target.jsp" method="GET">-->
<!--	  <input name="tg_sch" type="hidden">-->
<!--      <tr>-->
...
<!--	  </form>-->
      <tr>
        <td ><img src="../../../images/admin/site_type/btn_groupedit.gif" onclick="edit_sg();" style="cursor:hand;"><img src="../../../images/admin/site_type/btn_groupdel.gif"  hspace="5" onclick="del_sg();" style="cursor:hand;"></td>
      </tr>
      <tr>
        <td><img src="../../../images/admin/site_type/brank.gif" width="1" height="6"></td>
      </tr>
      <tr>
        <td height="20"><img src="../../../images/admin/site_type/admin_ico03.gif" width="10" height="11" hspace="3">분류사이트 리스트</td>
      </tr>
...
<%
	...
	sitelist = sitemng.getSgRelationType(sch,sg);
