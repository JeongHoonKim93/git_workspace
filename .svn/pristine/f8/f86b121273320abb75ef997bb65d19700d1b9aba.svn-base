...
<%
	...
	// 원문보기 권한 줄 ID
	//final String[] id_chk = {"devel", "jongwon", "cwjeong", "bae", "shbae", "jwpark", "hjjung"};
	boolean ipChk = false;
	//원문보기 권한 부여
	...
	arrIdBean = issueMgr.getIssueDataList(nowPage,pageCnt,check_no,i_seq,it_seq,"","","1",sDateFrom,"",sDateTo,"",typeCode,"","Y","","","","",0);
