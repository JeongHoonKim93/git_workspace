...
%>			
			<%-- <img src='../../../images/admin/keyword/<%=exkeyinfo.getK_img()%>' border="0" align="absmiddle"> --%>
			<option value="<%=exkeyinfo.getKGtype()%>"><%=exkeyinfo.getKGvalue()%> (<%=exkeyinfo.getK_op_type()%>)</option>
<%
		}
%>
