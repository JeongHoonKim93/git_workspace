			...
			<table width="820" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
						<tr>
							<td><img src="../../../images/admin/classification/tit_icon.gif" /><img src="../../../images/admin/classification/tit_0508.gif" /></td>
							<td align="right">
							<table border="0" cellpadding="0" cellspacing="0">
								<tr>
									<td class="navi_home">HOME</td>
									<td class="navi_arrow">관리자</td>
									<td class="navi_arrow2">분류체계 관리</td>
								</tr>
							</table>
							</td>
						</tr>
			      ...
			      <tr>
			        <td width="300" valign="top"><table width="300" border="0" cellspacing="0" cellpadding="0">
			          ...
			          <tr>
			              ...
			              <tbody>
			                <tr bgColor=#d5d5d5>
			                  <td style="padding-right: 0px; padding-left: 10px; padding-bottom: 5px;padding-top: 5px" Align=top bgColor=#ffffff colSpan=5>
			                    <iframe id=frm_menu style="width: 285px; height: 300px" border=0  name=frm_menu src="frm_test_classification.jsp"  frameBorder=0></iframe>
			                  </td>
			               </tr>
			              </tbody>
			            </table></td>
 			          ...
 			          <tr>
			          <td style="padding-top: 5; text-align: right;"><img src="../../../images/admin/keyword/up_btn.gif" width="18" height="18" onclick="up_code();" style="cursor:pointer;"><img src="../../../images/admin/keyword/down_btn.gif" width="18" height="18" hspace="5" onclick="down_code();" style="cursor:pointer;"></td>
			          </tr>
			              ...
			              <tbody>
			                <tr bgColor=#d5d5d5>
			                  <td style="padding-right: 0px; padding-left: 0px; padding-bottom: 0px;padding-top: 0px" align=top bgColor=#ffffff colSpan=5>
			                    <iframe id="frm_detail" name="frm_detail" style="width: 380px; height: 320px" border="0" src="frm_classification_test_detail.jsp"  frameBorder="0"></iframe>
			                  </td>
			               </tr>
			              </tbody>
			            </table>
