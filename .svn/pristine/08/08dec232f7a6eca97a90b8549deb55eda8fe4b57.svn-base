...
<%
	...
	kBean = kmgr.getKeyword(kSeq);

	ar_k_seq_L =  kmgr.getComKeyword(kSeq, KeywordBean.Type.LEFT);
	ar_k_seq_R =  kmgr.getComMapKeyword(kSeq, KeywordBean.Type.RIGHT);
	ar_s_seq_L =  kmgr.getProKeyword(kSeq, KeywordBean.Type.LEFT);
	ar_s_seq_R =  kmgr.getProMapKeyword(kSeq, KeywordBean.Type.RIGHT);
...
<script language="javascript">
	...
	function pageInit()
	{
		showDataList('mcompany','left');
		showDataList('mcompany','right');
		showDataList('mproduct','left');
		showDataList('mproduct','right');
	}
			  ...
			  <td style="height:30px;"><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#E0E0E0">
                <tr>
                  <td bgcolor="#F6F6F6" style="padding:10px 10px 10px 10px"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="20"><img src="../../../images/admin/aekeyword/arrow.gif" width="6" height="7"><span class="blue_text"><strong>키워드명 : <%=kBean.getK_value()%></strong></span></td>
                    </tr>
                  </table></td>
                </tr>
              </table></td>
			...
			<tr>
				<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="6%" align="center"><img src="../../../images/admin/aekeyword/btn_left.gif" style="cursor: pointer;" onclick="updateKeyword('mcompany','del');"><br>
                    <img src="../../../images/admin/aekeyword/btn_right.gif" width="18" height="18" vspace="5" style="cursor: pointer;" onclick="updateKeyword('mcompany','add');"></td>
                    <td width="47%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
			...
			<tr>
				<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="6%" align="center"><img src="../../../images/admin/aekeyword/btn_left.gif" width="18" height="18" style="cursor: pointer;" onclick="updateKeyword('mproduct','del');"><br>
                        <img src="../../../images/admin/aekeyword/btn_right.gif" width="18" height="18" vspace="5" style="cursor: pointer;" onclick="updateKeyword('mproduct','add');"></td>
                    <td width="47%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
