...
<!--
	...
	{				
		...
		if(mode=='update')
		{
			popup.openByPost('managerForm','portal_keyword_edit.jsp',400,235,false,false,false,'trendPop');
		}else{
			popup.openByPost('managerForm','portal_keyword_add.jsp',400,155,false,false,false,'trendPop');
		}
...
<input type="hidden" name="pkSeq" id="pkSeq">
		...
		<table style="width:820px;" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td><img src="../../../images/admin/portal_keyword/tit_icon.gif" /><img src="../../../images/admin/portal_keyword/tit_0505.gif" /></td>
						<td align="right">
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td class="navi_home">HOME</td>
								<td class="navi_arrow">관리자</td>
								<td class="navi_arrow2">포탈키워드관리</td>
							</tr>
						</table>
						</td>
					</tr>
			...
			<tr>
				...
				<table id="search_box" border="0" cellpadding="0" cellspacing="0">
					<tr>
						<th>검색 단어</th>
						<td style="vertical-align:middle"><input style="width:500px;vertical-align:middle" class="textbox" type="text" name="searchWord" onkeypress="Javascript:if (event.keyCode == 13) { Search(); }" style="vertical-align:middle">
						&nbsp;
						<img src="../../../images/admin/portal_keyword/btn_search.gif" style="vertical-align:middle;cursor:pointer" onclick="Search();"/></td>
					</tr>
				</table>
				</td>
			</tr>
			...
			<tr>
				...
				<table border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td><img src="../../../images/admin/portal_keyword/btn_allselect.gif" style="cursor:pointer" onclick="selectAll(!document.managerForm.checkAll.checked);"/>&nbsp;</td>
						<td><img src="../../../images/admin/portal_keyword/btn_add2.gif" style="cursor:pointer" onclick="popupEdit('','insert');"/>&nbsp;</td>
						<td><img src="../../../images/admin/portal_keyword/btn_del.gif" style="cursor:pointer" onclick="deleteWord();"/>&nbsp;</td>
					</tr>
				</table>				
				</td>
			</tr>
