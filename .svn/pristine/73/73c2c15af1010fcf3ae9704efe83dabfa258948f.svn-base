...
public class HashtagBean {
	...
	public String getHcActive() {
		return hcActive;
	}
	public void setHcActive(String hcActive) {
	...
	public String getK_op_type() {
		return k_op_type;
	}
	public void setK_op_type(String k_op_type) {
		this.k_op_type = k_op_type;
	}
