				...
				<table style="height:350px;" border="0" cellpadding="0" cellspacing="0">
					<tr>
						...
						<table style="width:100%;height:100%;" border="0" cellpadding="0" cellspacing="0">
							...
							<tr>
								<td>
									<iframe id="usergroup_left" name="usergroup_left" src="ifram_usergroup_left.jsp" width="300" height="450" scrolling="auto" frameborder="0"></iframe>
								</td>
							</tr>
							<tr>
						...
						<table style="width:100%;height:100%;" border="0" cellpadding="0" cellspacing="0">
							...
							<tr>
								<td>
									<iframe id="usergroup_right" name="usergroup_right" src="ifram_usergroup_right.jsp" width="480" height="450" scrolling="auto" frameborder="0"></iframe>
								</td>
							</tr>
							<tr>
