...
public class userEnvInfo implements Serializable {
    ...
    public String getS_Chart() {
		return S_Chart;
	}
	public void setS_Chart(String s_Chart) {
		S_Chart = s_Chart;
	}
	...
	public String getMg_company() {
		return mg_company;
	}
	public void setMg_company(String mg_company) {
		this.mg_company = mg_company;
	}
