...
public class userEnvMgr {
    ...
    public userEnvInfo queryUserEnv(String psUserID ) {
        try {
            ...
            if ( rs.next() ) {
                 ...
                 uei.setMg_company(rs.getString("MG_COMPANY"));
     ...
     * @return boolean
     */
    public boolean saveUserReloadTimeEnv( 
			String psS_Reflash  ,
            String psM_Seq )
    	{
        ...
        try {
            ...
            sb.append("UPDATE SETTING                                     \n");
            sb.append("   SET ST_RELOAD_TIME = " + psS_Reflash + "          \n");
            sb.append(" WHERE M_SEQ = " + psM_Seq     + "           \n");
