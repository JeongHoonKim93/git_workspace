...
<%@ page import="risk.admin.warning_keyword.KeywordMng" %>
<%@ page import="risk.admin.warning_keyword.KeywordBean" %>
...
<input type="hidden" name="sg_seqs">
  <tr>
    <td height="20" style="padding-left:7px"><img src="../../../images/admin/warning/admin_ico02.gif" width="8" height="5" hspace="3" align="absmiddle"><span class="menu_black"><strong><%=value%><%if(!part.equals("total")) out.print(" - ");%><%=partname%></strong></span></td>
  </tr>
</table>
<table width="315" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="300" border="0" cellspacing="0" cellpadding="0">
      <tr height="10">
        <td><img src="../../../images/admin/warning/brank.gif" width="1" height="5"></td>
      </tr>
<%
...
%>
      <tr>
        <td><img src="../../../images/admin/warning/admin_ico03.gif" width="10" height="11" hspace="3"><%=partname%>명</td>
      </tr>
      <tr>
        <td height="25"><input name="val" type="text" size="36" value="<%=value%>" OnKeyDown="Javascript:if (event.keyCode == 13) { edit_kg();}">
          <img src="../../../images/admin/warning/admin_modify.gif" width="45" height="18" align="absmiddle" onclick="edit_kg();" style="cursor:hand;"></td>
      </tr>
<%
	}
%>
...
%>
      <tr>
        <td><img src="../../../images/admin/warning/admin_ico03.gif" width="10" height="11" hspace="3">제외단어 리스트</td>
      </tr>
      <tr height="3">
        <td></td>
      </tr>
...
%>
		</select>&nbsp;<img src="../../../images/admin/warning/admin_del.gif" width="45" height="18" border="0" onclick="del_exkg();" style="cursor:pointer; vertical-align: bottom">
		</td>
      </tr>
      ...
      <tr>
      	<td style="padding-top: 5px"><img src="../../../images/admin/warning/admin_ico03.gif" width="10" height="11" hspace="3">최대 인접 자릿수 </td>
      </tr>
      <tr height="5">
        <td></td>
      </tr>
      <tr>
        <td valign="top" style="padding-left: 20px">최대 <input type="text" name="nearLen" style="width: 35px;text-align: right;" maxlength="4"  onkeydown="return onlyNumber(event)" value="<%=near_len%>"> 자 &nbsp; <img src="../../../images/admin/warning/admin_save.gif" style="vertical-align: middle; cursor: pointer;" onclick="nearLenSave();">&nbsp;&nbsp;<img src="../../../images/admin/warning/admin_all_save.gif" style="vertical-align: middle; cursor: pointer;" onclick="nearLenSaveAll();"></td>
       </tr>
       <%} %> 
