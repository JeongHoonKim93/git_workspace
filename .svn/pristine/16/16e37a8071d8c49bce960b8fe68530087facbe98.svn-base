...
<img src="../../../images/admin/warning/layer_img.gif" style="cursor:hand" onclick="closeLayer();"></img>
</div>
			...
			<table width="820" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
						<tr>
							<td><img src="../../../images/admin/warning/tit_icon.gif" /><img src="../../../images/admin/warning/tit_0529.gif" /></td>
							<td align="right">
							<table border="0" cellpadding="0" cellspacing="0">
								<tr>
									<td class="navi_home">HOME</td>
									<td class="navi_arrow">관리자</td>
									<td class="navi_arrow2">워닝키워드관리</td>
								</tr>
							</table>
							</td>
						</tr>
              ...
              <tr>
                ...
                <td width="220" align="left" valign="top"><table width="220"  border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td height="25" class="textBbig" >
                    	<table width="100%" border="0">
                    		<tr>
                    			<td align="left"><img src="../../../images/admin/warning/admin_ico01.gif" width="12" height="10" hspace="2"><strong>키워드그룹</strong></td>
                    			<td align="right"><img src="../../../images/admin/warning/excel_save.gif" width="94" height="24" hspace="2" onclick="keySave();" style="cursor:hand;"></td>
                    		</tr>
                    	</table>
                    </td>
                  </tr>
                  ...
                  <table width="240" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><img src="../../../images/admin/warning/form_add.gif" vspace="5" OnKeyDown="Javascript:if (event.keyCode == 13) { add_key();}" onclick="add_key();" style="cursor:hand;"><img src="../../../images/admin/warning/form_del.gif" hspace="5" vspace="5" onclick="del_key();" style="cursor:hand;"></td>
                      <td align="right"><img src="../../../images/admin/warning/up_btn.gif" width="18" height="18" onclick="up_key();" style="cursor:hand;"><img src="../../../images/admin/warning/down_btn.gif" width="18" height="18" hspace="5" onclick="down_key();" style="cursor:hand;"></td>
                    </tr>
                  </table></td>
                <td width="30" align="left">&nbsp;</td>
                <td width="335" align="left" valign="top"><table width="335"  border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td height="25" align="left" class="textBbig" ><img src="../../../images/admin/warning/admin_ico01.gif" width="12" height="10" hspace="2"><strong>세부정보</strong></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
		          	<td height="10" align="right"><img src="../../../images/admin/warning/banner_01.gif" style="cursor:hand" onclick="openLayer();"></td>
		          </tr>
                </table>                  
                  <table width="335" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td align="right"><!--<img src="../../../images/admin/warning/btn_save.gif" width="48" height="21" vspace="5">--></td>
                    </tr>
                  </table></td>
                <td align="left">&nbsp;</td>
              </tr>
