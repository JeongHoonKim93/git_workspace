...
/* 	
    ...
    MetaMgr_warning    smgr = new MetaMgr_warning();
...
<!--
    ...
    */
    function idxProcess(mode) {
		...
		f.action = 'search_main_warning.jsp';
		f.target = '';
		f.submit();
    }
    ...
    */
    function pageClick(paramUrl){
    	...
    	var f = document.getElementById('fSend');
        f.action = "search_main_warning.jsp" + paramUrl;
        doSubmit();
    }
    ...
    */
    function doSearch(){
    	document.fSend.action = 'search_main_warning.jsp';
	...
	*/	
	...
	function saveExcel() {
		...
		var f = document.fSend;
        f.action = "search_warning_download_excel.jsp";
        f.target = 'proceeFrame';
        f.submit();
...
<input type="hidden" name="subMode" value="warning">
		...
		%> --%>
			...
			<tr>
				...
				<table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td><img src="../../images/search/tit_icon.gif" /><img src="../../images/search/tit_0110.gif" /></td>
						<td align="right">
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td class="navi_home">HOME</td>
								<td class="navi_arrow">정보검색</td>
								<td class="navi_arrow2">워닝키워드검색</td>
							</tr>
						</table>
						</td>
					</tr>
			...
			<tr>
				<td>
				<form name="fSend" id="fSend" action="search_main_warning.jsp" method="post"  style="margin-bottom: 0px;" >
