...
/* 	
    ...
    DomainKeywordMgr     smgr = new DomainKeywordMgr();
...
<!--
    ...
    */
    function idxProcess(mode) {
        ...
        f.action = "idx_prc.jsp?idxMode="+mode + "&subMode=domain";
        f.target = 'if_samelist';
        f.submit();
        
		f.action = 'domain_main_contents.jsp';
		f.target = '';
		f.submit();
    }
    ...
    */
    function pageClick(paramUrl){
    	...
    	var f = document.getElementById('fSend');
    	f.target = '';
        f.action = "domain_main_contents.jsp" + paramUrl;
        doSubmit();
    }
    ...
    */
    function doSearch(){
    	document.fSend.action = 'domain_main_contents.jsp';
	...
	*/	
	...
	function saveExcel() {
		...
		var f = document.fSend;
        f.action = "domain_download_excel.jsp";
        f.target = 'proceeFrame';
        f.submit();
...
<form name="send_comfirm" id="send_comfirm" method="post">
	...
	<input type="hidden" name="subMode" value="domain">
</form>
		...
		%> --%>
			...
			<tr>
				...
				<table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td><img src="../../images/search/tit_icon.gif" /><img src="../../images/search/tit_0614.gif" /></td>
						<td align="right">
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td class="navi_home">HOME</td>
								<td class="navi_arrow">정보검색</td>
								<td class="navi_arrow2">영역지정키워드검색</td>
							</tr>
						</table>
						</td>
					</tr>
			...
			<tr>
				<td>
				<form name="fSend" id="fSend" action="domain_main_contents.jsp" method="post"  style="margin-bottom: 0px;" >
