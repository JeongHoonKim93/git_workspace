					...
					<tr>
						...
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								...
								<td class="navi_arrow2">제외키워드검색</td>
							</tr>
						</table>
						</td>
					</tr>
...
<%-- 				          <tr>
				          ...
				          <tr>
				            <td style="padding:5px 0px 5px 7px"><table width="790" border="0" cellspacing="0" cellpadding="0">
				              <tr>
				                <td width="75" class="b_text"><img src="../../images/search/icon_search_bullet.gif" width="9" height="9" /> <strong>검색언어</strong></td>
		...
		<table style="width:820px;" border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<table border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td style="padding-right: 3px"><img src="../../images/search/btn_allselect.gif" onclick="reverseAll(!document.getElementById('fCheck').chkAllCheck.checked);"/></td>
<%
	if(uei.getSearchMode().equals("EX_ALLKEY")){
%>  
						<td style="padding-right: 3px"><span style="<%=viewManager%>"><img src="../../images/search/btn_del.gif" onclick="idxProcess('truncate');" style="cursor:pointer"/></span></td>
<!--						<td><span style="<%=viewManager%>"><img src="../../images/search/btn_bookmark.gif" onclick="saveBookMark();" style="cursor:pointer"/></span></td>-->
<!--						<td><span style="<%=viewManager%>"><img src="../../images/search/btn_bookmark_search.gif" onclick="doBookMarkSearch();" style="cursor:pointer"/></span></td>-->
						<td style="padding-right: 3px"><img src="../../images/search/btn_multire.gif" onclick="exceptionRestore_multi();" style="cursor:pointer"/></td>
						
<!--						<td><input type="button" value="지우개" style="width: 88px; height: 24px" onclick="listClear('<%=uei.getM_seq()%>')"></td>-->
<%
	}else if(uei.getSearchMode().equals("DELIDX")){
%>
						<td style="padding-right: 3px"><span style="<%=viewManager%>"><img src="../../images/search/btn_restoration.gif" onclick="idxProcess('revert');" style="cursor:pointer"/></span></td>
						<td style="padding-right: 3px"><span style="<%=viewManager%>"><img src="../../images/search/btn_del3.gif" onclick="idxProcess('del');" style="cursor:pointer"/></span></td>
						<td style="padding-right: 3px" align="right"><b style="color:navy">* 휴지통의 기사는 삭제 7일 후 영구삭제 됩니다.</b></td>
<%
	}
%>
					</tr>
...
<%
	if(!uei.getSearchMode().equals("DELIDX")){
%>
				<col width="5%"><col width="15%"><col width="51%"><col width="4%"><col width="10%"><col width="15%">
<%
	}else{
%>
...
%>
					<tr style="background-color:<%=bookMarkColor%>" onmouseover="this.style.backgroundColor='<%=overColor%>';" onmouseout="this.style.backgroundColor='<%=outColor%>';">
						<!--↓↓체크박스-->
						<td><input type="checkbox" name="chkData" onclick="detectChk(this.checked)" value="<%=mBean.getMd_seq()%>"></td>
						<!--↓↓출처-->
						...
						<!--↓↓복원버튼-->
						<td><span style="<%=viewManager%>"><img src="../../images/search/btn_re.gif" style="cursor:pointer" onclick="exceptionRestore('<%=mBean.getMd_seq()%>')"></span></td>
