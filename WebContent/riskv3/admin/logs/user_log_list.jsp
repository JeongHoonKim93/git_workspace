...
<form name="sch_log" action="user_log_list.jsp" method="post">
...
%>
			...
			<!-- 검색 끝 -->
			<tr>
				<td style="height:45px; text-align: right"><b><%=logMgr.getListCnt()%></b>건 , <b><%=nowpage%>/<%=(logMgr.getListCnt()/PAGE_SIZE)%></b>page</td>
			</tr>
			<!-- 게시판 시작 -->
			<tr>
				<td>       
