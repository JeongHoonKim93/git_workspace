...
<%@ page import="	java.util.ArrayList
                 	,risk.mobile.PortalAlimiReceiverBean
...
<%
	...
	String existsAb_seq = "";
	arrReceiverList = pasDao.getAddressList("","","");	
...
<tr>
	...
	<col width="5%"><col width="15%"><col width="15%"><col width="15%">
		<tr>           
...
<%
	if(arrReceiverList.size()>0){
		for(int i=0; i<arrReceiverList.size(); i++){
			...
			arBean = (PortalAlimiReceiverBean)arrReceiverList.get(i);
