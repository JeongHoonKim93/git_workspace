...
<%
	...
	SiteTypeMng SGmng = new SiteTypeMng();

	if( mode.equals("ins") ) {
		title = "사이트그룹 추가";
	} else if( mode.equals("edit") ) {
		title = "사이트그룹 수정";
		sgval = SGmng.getSiteGroupType(sgseq);
	}
%>
<html>
<head>
<title>insight V3 - RSN</title>
...
<iframe id="tg_sitemng" name="tg_sitemng" width="0" height="0" style="display: none;"></iframe>
</html>
