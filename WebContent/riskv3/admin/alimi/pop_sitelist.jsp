...
//	String selectedSdGsn = pr.getString("selectedSdGsn","");
	String selectedSdGsn = pr.getString("sd_gsns","");
...
<table width="850" border="0" cellspacing="0" cellpadding="0">	
	...
	<tr>
        <td colspan="3" bgcolor="#9CBBE5"><img src="../../../images/admin/alimi/brank.gif" width="1" height="2"></td>
    </tr>														
    ...
    <tr>
        <td colspan="3"><img src="../../../images/admin/alimi/brank.gif" width="1" height="5"></td>
    </tr>
	<tr>		
