...
<%
	...
	ArrayList reData = lMgr.getTelegramManualLogList(iNowPage , rowCnt, sDateFrom, sDateTo, searchKey, tl_code);
...
<!--
	...
	function pageClick( paramUrl ) {
		...
		f.action='alimi_manual_log_list.jsp'+ paramUrl;
		f.submit();
    }
	...
	//검색
 	function search(){ 		
		...
		f.nowpage.value = '1';
 		f.action = 'alimi_manual_log_list.jsp';
 		f.target = '';
 		f.submit(); 	
 	}
		...
		<table style="width:820px;" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td><img src="../../../images/admin/alimi/tit_icon.gif" /><img src="../../../images/admin/alimi/tit_1208.gif" /></td>
						<td align="right">
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td class="navi_home">HOME</td>
								<td class="navi_arrow">관리자</td>
								<td class="navi_arrow2">텔레그램 수동 발송로그</td>
							</tr>
						</table>
						</td>
					</tr>
				        ...
				        <td width="818" bgcolor="F7F7F7" style="padding:10px 0px 5px 0px"><table width="798" border="0" align="center" cellpadding="0" cellspacing="0">
				          <tr>
				            <td height="24" style="padding:0px 0px 5px 7px"><table width="790" border="0" cellspacing="0" cellpadding="0">
				              <tr>
				             	<td width="5px" class="b_text"><img src="../../../images/issue/icon_search_bullet.gif" width="9" height="9" /> <strong>그     룹</strong></td>
				                <td width="150px"><select name="tl_code" class="textbox3" style="width: 125px">
								                  <option value="">선택하세요</option>
								                  <option value="1" <%if(tl_code.equals("1")){out.print("selected");}%>>현대카드 알리미1</option>
								                  <option value="2" <%if(tl_code.equals("2")){out.print("selected");}%>>현대카드 알리미2</option>
								                  <option value="3" <%if(tl_code.equals("3")){out.print("selected");}%>>현대카드 알리미3</option>
				                                </select></td>
			...
			<tr>
				...
				<col width="25%"><col width="45%"><col width="15%"><col width="15%">
					<tr>           
						<th>그     룹</th>
						<th>제     목</th>
						<th>발신자</th>
...
%>
					<tr>
						<td>현대카드 알리미<%=abean.getTl_code()%></td>
						<td style="text-align: left;white-space:nowrap;  text-overflow:ellipsis; overflow:hidden;"><%=abean.getTl_message()%></td>
						<td><%=abean.getTl_send_m_name()%></td>
