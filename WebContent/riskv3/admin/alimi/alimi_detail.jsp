...
<form name="address_book" action="receiver_prc.jsp" method="post">
  ...
  <tr>
    <td style="padding: 0px 0px 0px 10px;">
	    ...
	    <table width="750" border="0" cellspacing="0" cellpadding="0">
	      ...
	      <tr>
	        <td colspan="2" bgcolor="#9CBBE5"><img src="../images2/brank.gif" width="1" height="3"></td>
	      </tr>
	      <tr>
    ...
    <td style="padding: 0px 0px 0px 10px;">
		...
		<table width="730" border="0" cellspacing="0" cellpadding="0">
			<tr height="25" align="center">
			  ...
			  <td width="3">&nbsp;</td>
			  <td width="268" style="padding: 3px 0px 0px 0px;"><nobr style ="text-overflow:ellipsis; overflow:hidden; width:250" title=""></nobr></td>
			  <td width="3">&nbsp;</td>
			  <td width="150" style="padding: 3px 0px 0px 0px;"><nobr style ="text-overflow:ellipsis; overflow:hidden; width:130" title=""></nobr></td>
			  <td width="3">&nbsp;</td>
