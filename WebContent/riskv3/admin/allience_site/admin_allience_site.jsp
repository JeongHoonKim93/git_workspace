			...
			<table width="820" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
						<tr>
							<td><img src="../../../images/admin/site/tit_icon.gif" /><img src="../../../images/admin/site/tit_0307.gif" /></td>
							<td align="right">
							<table border="0" cellpadding="0" cellspacing="0">
								<tr>
									<td class="navi_home">HOME</td>
									<td class="navi_arrow">관리자</td>
									<td class="navi_arrow2">제휴컨텐츠관리</td>
								</tr>
							</table>
							</td>
						</tr>
        ...
        <tr>
          <td align="right" style="padding-left:10px"><table width="750" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td height="50" align="left"> 제휴컨텐츠를 관리합니다 .&#13;<br>
              좌측의 리스트에서 선택한 사이트를 우측리스트로 이동하시면 제휴컨텐츠 리스트에 등록이 됩니다 .&#13;&#13;</td>
            </tr>
            <tr>
              ...
              <tr>
				...
				<table width="335"  border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <input  name="sch_key" type="text" size="27" style="border:1 solid; border-color:#CCCCCC" OnKeyDown="Javascript:if (event.keyCode == 13) { search_SourceSite();}">
                    <img src="../../../images/admin/site/search_btn.gif" width="41" height="19" align="absmiddle" onclick="search_SourceSite();" style="cursor:hand;">
                    </form>
                    </td>
                  </tr>
                  <tr>
                ...
                <td width="335" align="left" valign="top">
                	<form name="target_form" action="ifram_target.jsp" method="post" target="tg_sitemng">
				...
				<table width="335"  border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td height="25" align="left" class="textBbig" >
                    	<table width="100%"  border="0" cellspacing="0" cellpadding="0">
                    		<tr>
                    			<td align="left"><img src="../../../images/admin/site/admin_ico01.gif" width="12" height="10" hspace="2"><strong>제휴컨텐츠 리스트</strong></td>
