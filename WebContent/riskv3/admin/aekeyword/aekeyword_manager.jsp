...
<!--
	...
	{				
		...
		if(mode=='update')
		{
			popup.openByPost('managerForm','aekeyword_edit.jsp',680,700,false,false,false,'trendPop');
		}else{
			popup.openByPost('managerForm','aekeyword_add.jsp',400,170,false,false,false,'trendPop');
		}
		...
		<table style="width:820px;" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td><img src="../../../images/admin/aekeyword/tit_icon.gif" /><img src="../../../images/admin/aekeyword/tit_0504.gif" /></td>
						<td align="right">
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td class="navi_home">HOME</td>
								<td class="navi_arrow">관리자</td>
								<td class="navi_arrow2">전체제외키워드관리</td>
							</tr>
						</table>
						</td>
					</tr>
