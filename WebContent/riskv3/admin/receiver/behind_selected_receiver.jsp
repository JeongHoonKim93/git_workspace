...
%>
							<tr>
								...
								<td style="text-align:right;display:none;" class="pop_mail_group_td">SMS발송<input type="checkbox" name="smsChk" value="<%=abBean.getMab_mobile()%>" <%if(abBean.getMab_sms_chk().equals("1")){out.print("checked");}%>></td>
