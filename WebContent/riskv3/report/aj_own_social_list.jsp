...
<%
	...
	arData1 = reptMgr.getDailyReport("1", "2", ir_sdate, ir_stime, ir_edate, ir_etime);
	
%>
<!-- 자사 소셜 정보 -->
<table>
	<tr>
		<td style="height:50px;"><span class="sub_tit">자사 소셜 정보</span></td>
	</tr>
</table>
...
<col width="5%"><col width="12%"><col width="38%"><col width="5%"><col width="9%"><col width="9%"><col width="7%">
	<tr>
		<th><input type="checkbox" name="OSCheckall" value="" id="tt" onclick="checkAll2(this.name);"></th>
		<th>성향</th>
		<th>제목</th>
		<th></th>
		<th>출처</th>
...
%>				
	...
	<tr>
		<%-- <td><input type="checkbox" id="OSCheck<%=i %>" name="OSCheck" value="<%=idBean.getId_seq()%>" onclick="getListCnt(<%=i%>);"></td> --%>
		<td><input type="checkbox" id="OSCheck<%=i %>" name="OSCheck" value="<%=idBean.getId_seq()%>"></td>
