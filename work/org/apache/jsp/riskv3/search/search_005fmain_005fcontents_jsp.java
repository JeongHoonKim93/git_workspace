 ...
 /*   	ArrayList arrIssueBean = new ArrayList();
	...
	*/
    ...
    chartData = smgr.getChartData(sCurrDate, uei.getK_xp(), uei.getK_yp(), uei.getK_zp()); 
      ...
      out.write("    \tdocument.fSend.action = 'search_main_contents.jsp';\r\n");
      ...
      out.write("\r\n");
      out.write("    \r\n");
      out.write("    function selectTopKeyword(day, k_xp, k_yp, k_zp){\r\n");
      out.write("    \t//검색 날짜 변경\r\n");
      out.write("    \tsetTargetDate(day);\r\n");
      out.write("    \tvar f = document.getElementById('fSend');\r\n");
      out.write("\t\tf.xp.value = k_xp;\r\n");
      out.write("\t\tf.yp.value = k_yp;\r\n");
      out.write("\t\tf.zp.value = k_zp;\r\n");
      out.write("        \r\n");
      out.write("\t\tdoSubmit();\r\n");
      out.write("    }\r\n");
      out.write("    \r\n");
      out.write("    \r\n");
      out.write("    function setTargetDate( day ) {\r\n");
      out.write("        var f = document.getElementById('fSend');\r\n");
      out.write("        f.sDateFrom.value   = getdate( day );\r\n");
      out.write("        f.sDateTo.value     = getdate( day );\r\n");
      out.write("    }\r\n");
      out.write("    \r\n");
      out.write("    /**\r\n");
      out.write("    * 검색기간\r\n");
      ...
      out.write("    \tif_samelist.location.href = \"inc_same_list.jsp?md_pseq=\" + md_pseq + \"&md_seq=\" + md_seq + \"&searchMode=\" + searchMode+ \"&issue_Check=\"+issue_Check;\r\n");
      ...
      out.write("\t*/\r\n");
      out.write("\tfunction send_issue(mode, md_seq, writername){\r\n");
      ...
      out.write("\t\t\tdocument.send_mb.writername.value = writername;\t\r\n");
      out.write("\t\t\t\r\n");
      ...
      out.write("\t\r\n");
      out.write("\t //급상승키워드관련\r\n");
      out.write("    function upKeywordList(type, obj){\r\n");
      out.write("\t\tvar f = document.getElementById('fSend');\r\n");
      out.write("        f.upKeywordType.value = type;\r\n");
      out.write("        \r\n");
      out.write("\t\tvar keyObj = document.getElementsByClassName('upKeywordMenu');\r\n");
      out.write("        if(keyObj){\r\n");
      out.write("            if(keyObj.length){\r\n");
      out.write("                for(var i = 0; i < keyObj.length; i++){\r\n");
      out.write("                \t//keyObj[i].background = keyObj[i].background.replace('on', 'off');\r\n");
      out.write("                \tsetOff(keyObj[i]);\r\n");
      out.write("\r\n");
      out.write("                }\r\n");
      out.write("            }\r\n");
      out.write("        }\r\n");
      out.write("        //obj.background = obj.background.replace('off', 'on');\r\n");
      out.write("        setOn(obj);\r\n");
      out.write("        \r\n");
      out.write("        ajax.post(\"upKeyword.jsp\", \"fSend\", \"upKeywordArea\");\r\n");
      out.write("    }\r\n");
      out.write("    \r\n");
      ...
      out.write("    {\r\n");
      out.write(" \t\tvar oSrc = obj.style.backgroundImage;\r\n");
      out.write("    \tre = /_off./i;\r\n");
      out.write("    \tvar nSrc = obj.style.backgroundImage.replace(re, \"_on.\");\r\n");
      out.write("    \tobj.style.backgroundImage = nSrc;\r\n");
      out.write("    }\r\n");
      out.write("    function setOff(obj)\r\n");
      out.write("    {\r\n");
      out.write("    \tvar oSrc = obj.style.backgroundImage;\r\n");
      out.write("    \tre = /_on./i;\r\n");
      out.write("    \tvar nSrc = obj.style.backgroundImage.replace(re, \"_off.\");\r\n");
      out.write("    \tobj.style.backgroundImage = nSrc;\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t//window.open(url,'hrefPop'+chkOriginal,'');\r\n");
      out.write("\t\t\twindow.open('http://hub.buzzms.co.kr?url=' + encodeURIComponent(url),'hrefPop'+chkOriginal,'');\r\n");
      out.write("\t\t}else if(s_seq == '5032785'){\r\n");
      out.write("\t\t\t//네이버까페\r\n");
      out.write("\t\t\t//url = \"http://section.cafe.naver.com/CombinationSearch.nhn?query=\" + md_title;\r\n");
      out.write("\t\t\t//url = \"https://section.cafe.naver.com/cafe-home/search/articles?query=\\\"\" +md_title+\"\\\"\";\r\n");
      out.write("\t\t\turl = \"https://cafe.naver.com/ca-fe/home/search/articles?pr=2&se=1&et=\"+ md_title;\r\n");
      ...
      out.write("\t\t $.ajax({\r\n");
      out.write("\t\t \t type:\"post\",\r\n");
      out.write("\t\t \t url: \"meta_data_prc.jsp\",\r\n");
      out.write("\t\t \t async : true,\r\n");
      ...
      out.write("\r\n");
      out.write("<!--헤드라인 레이어-->\r\n");
      out.write("<div id=div_show style=\"font-size: 12px; padding-right: 5px; display: none; padding-left: 5px; left: 140px; width:500px; height:auto; padding-bottom: 5px; padding-top: 5px; position: absolute; background-color: #f0f0f0; border: #555555 2px solid;\"></div>\r\n");
      out.write("\r\n");
      out.write("<!-- 원문저장 -->\r\n");
      ...
      out.write("<input type=\"hidden\" name=\"writername\">\r\n");
      out.write("</form>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td><img src=\"../../images/search/tit_icon.gif\" /><img src=\"../../images/search/tit_0102.gif\" /></td>\r\n");
      ...
      out.write("\">\r\n");
      out.write("\t\t\t\t\t<input type=\"hidden\" name=\"upKeywordType\" id=\"upKeywordType\" value=\"");
      out.print(upKeywordType);
      out.write("\">\r\n");
...
if(alGroup.size() == arrSelected.length){out.print("checked");}
      ...
      out.write("\t\t\t\t              <tr>\r\n");
      out.write(" \t\t\t\t                \r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td width=\"120\" class=\"b_text\"><img src=\"../../images/search/icon_search_bullet.gif\" width=\"9\" height=\"9\" /> <strong>이슈등록 여부</strong></td>\r\n");
      out.write("\t\t\t\t          \t\t\t<td style=\"color:#2f5065;\" >\r\n");
      out.write("\t\t\t\t          \t\t\t\t<select name=\"issue_check\" id=\"issue_check\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option value=\"\" ");
if(issue_check.equals("")){out.print("selected");}
      out.write(">전체</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option value=\"Y\" ");
if(issue_check.equals("Y")){out.print("selected");}
      out.write(">등록</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option value=\"N\" ");
if(issue_check.equals("N")){out.print("selected");}
      out.write(">미등록</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t          \t\t\t</td>\r\n");
      out.write("\t\t\t\t              </tr>\r\n");
      out.write("\t\t\t\t            </table></td>\r\n");
...
if(uei.getSt_reload_time().equals("30")) out.println("selected");
	...
	if(uei.getSearchMode().equals("ALLKEY")){
      ...
      out.write("\t\t\t\t\t\t<td>&nbsp;</td>\r\n");
      out.write("\t\t\t\t\t\t<td><img src=\"../../images/search/btn_sensing.gif\" onclick=\"send_issue('new');\" style=\"cursor:pointer\"/></td>\r\n");
      out.write("\t\t\t\t\t\t<td>&nbsp;</td>\r\n");
	...
	if(!uei.getSearchMode().equals("DELIDX")){
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<th><input type=\"checkbox\" id=\"chkData\" name=\"chkAllCheck\" value=\"\" onclick=\"reverseAll(this.checked);\"></th>\r\n");
	...
	if(!uei.getSearchMode().equals("DELIDX")){
      ...
      out.write("\t\t");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<th><span style=\"");
      out.print(viewManager);
      out.write("\">관리</span></th>\r\n");
      out.write("\t");
      out.write("\r\n");
      out.write("\t\t\r\n");
...
/*         	//댓글이 있을경우
      ...
      out.write("\" style=\"text-overflow:ellipsis;overflow:hidden;white-space:nowrap;width:390px; text-align:left; display: inline-block; \"  >\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      out.print(star);
      out.write("\r\n");
      out.write(" \t\t\t\t\t\t\t\t");
...
if(viewManager.equals("")){
	...
	if(uei.getSearchMode().equals("ALLKEY")){
      ...
      out.write("\t\t</td> -->\r\n");
      out.write("\t\t<!-- 퀵 -->\r\n");
      out.write("<!-- \t\t<td valign=\"top\" style=\"padding-top: 82px;\"> -->\t\t\t\t\r\n");
      out.write('\r');
      out.write('\n');
      out.write("\r\n");
