...
public final class behind_005fex_005fsite_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
//@ page contentType="text/html; charset=euc-kr"
	...
	arrEKbean = ekMgr.getKeywordList(searchWord, order); */	
      ...
      out.write("<col width=\"5%\"><col width=\"30%\"><col width=\"50%\">\r\n");
      out.write("\t<tr>               \r\n");
      out.write("\t\t<th ><input type=\"checkbox\" name=\"checkAll\" onclick=\"selectAll(this.checked);\"></th>\r\n");
      out.write("\t\t<th style=\"text-align: left;\">사이트(그룹)</th>");
      out.write("\r\n");
      out.write("\t\t<th style=\"text-align: left;\">제외 URL</th>\r\n");
      out.write("\t\t");
      out.write("\r\n");
      out.write("\t</tr>\r\n");
	...
	if(arExSite != null && arExSite.size() > 0){
      ...
      out.print(tmp[0]);
      out.write("\"></td>\r\n");
      out.write("\t\t<td><p onclick=\"popupEdit('");
      out.print(tmp[0]);
      out.write("','update');\" style=\"cursor:pointer;text-align: left;\">");
      out.print(tmp[3]);
      out.write('(');
      out.print(tmp[4]);
      out.write(")</p></td><!--  제외사이트  -->\r\n");
      out.write("\t\t<td><p onclick=\"popupEdit('");
      out.print(tmp[0]);
      out.write("','update');\" style=\"cursor:pointer;text-align: left;\">");
      out.print(tmp[2]);
      ...
      out.write(" <!-- 제외단어 -->\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t<!-- TO DO LIST 이게 공백이면 DOT가 안생김 IE 8.0 VERSION-->\r\n");
      out.write("\t\t");
      out.write("\r\n");
      out.write("\t</tr>\r\n");
